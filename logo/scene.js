...
const embed=new URLSearchParams(location.search).has('embed') || (new URLSearchParams(location.search).has('home') && innerWidth<700);if(embed)document.body.classList.add('embed');
